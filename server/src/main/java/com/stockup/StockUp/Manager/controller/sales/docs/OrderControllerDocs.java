...
public interface OrderControllerDocs {
	...
	@Operation(
		...
		description = "Returns a pageable listPurchaseOrder of orders.",
		responses = {
			@ApiResponse(
				responseCode = "200",
	...
	@Operation(
		...
		description = "Soft deleteCashMovement: marks the order IPurchaseOrderService disabled or deleted.",
		responses = {
